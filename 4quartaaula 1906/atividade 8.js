...
var alturaEmMetros = Number(prompt("Digite sua altura em centímetros: "));
var peso = Number(prompt("Digite seu peso em kilos: "));
...
if (imc < 18) {
  ...
  alert("Seu IMC é: " + imc.toFixed(2) + ". Você está na faixa de peso ideal.");
} else {

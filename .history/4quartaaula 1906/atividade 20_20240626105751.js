...
alert("Resultados da equipe " + nomeEquipe + ":");

for (var i = 0; i < 4; i++) {
    alert("Trecho " + (i + 1) + ": " + nomesIntegrantes[i] + " - Velocidade média: " + velocidadesTrechos[i] + " km/h");
}

alert("Velocidade média geral: " + velocidadeMediaGeral + " km/h");

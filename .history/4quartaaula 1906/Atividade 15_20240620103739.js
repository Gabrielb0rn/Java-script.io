...
var ovosComprados = prompt("Digite o número de ovos comprados: ");
if ovosComprados <= 12 {
    var valorTotal = ovosComprados * 40;
} else if ovosComprados <= 24 {
    var valorTotal = ovosComprados * 30;
} else {
    var valorTotal = ovosComprados * 25;
}
